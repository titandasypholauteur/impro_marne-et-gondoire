...
'<html lang="fr-FR">'+
'<head>'+
'<title>Troupes invitées</title>'+
'</head>'+
'<link rel="stylesheet" href="style.css">'+
'<body>'+
'    <br />'+
'    <h1><center>TROUPES INVITÉES</center></h1>'+
'    <br />'+
'    <p>Comme tu l\'as compris voire le sais, il faut deux troupes pour pouvoir jouer un match. Voici une liste de suggestion de troupes d\'impro qui joueraient :</p>'+
'    <br />'+
'    <li>Île-de-France</li>'+
'    <p>_les Malades de l\'Imaginaire (Paris 12<sup>ème</sup>)</p>'+
'    <p>_les Incubés (élèves des Malades de l\'Imaginaire)</p>'+
'    <p>_les Impro d\'Enfer (Paris 14<sup>ème</sup>)</p>'+
'    <p>_la LUDI-IDF</p>'+
...
'    <br />'+
'    <li>Normandie</li>'+
'    <p>_la Macédoine (Caen)</p>'+
'    <p>_Strac Frit (Rouen)</p>'+
'    <br />'+
'    <li>Bretagne</li>'+
'    <p>_TIR (Rennes)</p>'+
'    <br />'+
...
'    <p>_Improvergne (Clermont-Ferrand)</p>'+
'    <br />'+
'    <li>Bourgogne-Franche-Comté</li>'+
'    <li>_LUDI et ARTI (Besançon)</li>'+
'    <br />'+
'    <li>Grand-Est</li>'+
'    <p>_le Mitch (Reims)</p>'+
'    <p>_les Impropulseurs (Mulhouse)</p>'+
'    <p>_ImproDisiaque (Nancy)</p>'+
'    <br />'+
'    <br />'+
